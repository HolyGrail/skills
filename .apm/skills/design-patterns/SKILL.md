...
description: |
  コードベースに適用可能な GoF デザインパターン（生成・構造・振る舞い）を提案し、SOLID 原則の遵守状況とアンチパターン（God Object / Long Method / Magic Numbers 等）を評価してリファクタリング案を生成する。新規設計やレガシーコードの改善で適切なパターン選定や責務分離の指針を得たいときに使う。
---
