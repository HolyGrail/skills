---
description: |
  macOS の `screencapture` でウィンドウ／全画面／範囲選択のスクリーンショット撮影方法を案内し、ユーザーが撮影した画像を解析する（`/screenshot` 自体は撮影を行わない）。UI/UX レビュー・エラー画面の原因調査・デザイン評価・グラフ可視化分析など、画面の視覚情報を Claude に解釈させたいときに使う。
---
