---
description: |
  Python (PEP 257) / JSDoc / TSDoc / GoDoc / Rustdoc / DartDoc など言語別スタイルガイドに準拠し、概要 30-60 文字・詳細 50-200 文字・Claude マーカー必須の docstring を欠落要素や基準未達コメントに対して追加・更新する。既存コメントの言語（日本語/英語）を自動判定し既存の TODO・URL・注意事項・例は保持する。プロジェクト全体や特定ディレクトリのドキュメントコメントを体系的に整備したいときに使う。
---
